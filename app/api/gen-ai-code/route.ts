...
13. **MOBILE-FIRST & RESPONSIVE**: You MUST design the application to be highly responsive and mobile-first. All layouts, sidebars, navigation menus, and content grids MUST collapse gracefully on small screens, BUT they MUST permanently expand and remain fully visible on desktop screens (e.g., using Tailwind's \`md:flex\`, \`md:block\`, or \`lg:block\` prefixes). NEVER permanently hide sidebars or navigation on desktop sizes. Mobile responsiveness is CRITICAL.
