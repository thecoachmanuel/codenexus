...
14. **MOBILE-FIRST & RESPONSIVE**: You MUST design the application to be highly responsive. When implementing responsive sidebars and mobile menus, ensure your Tailwind breakpoints perfectly match to avoid UI dead zones. For example, if you hide the mobile menu at \`md:hidden\`, you MUST show the desktop sidebar at \`md:flex\`. Do NOT hide the menu at \`md\` while waiting until \`lg\` to show the sidebar, as this leaves screens between 768px and 1024px with NO navigation. Make your own decisions on the design approach, just ensure breakpoints are synchronized.
